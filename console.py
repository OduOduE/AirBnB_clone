...
# A global constant for all functions
CLASSES = [
        "BaseModel",
        "User",
        "City",
...
def check_args(args):
    ...
    Args:
        args (str): sting containing arhuments passed to command.
    Returns:
        Error message if args is None or invalid class, else the arguments.
    """
    arg_list - parse(args)
...
class HBNBCommand(cmd.Cmd):
    """ Implements the AirBnB clone web application console """
