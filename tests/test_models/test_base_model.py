#!/usr/bin/python3
""" A module containing test suite for the BaseModel class """
import unittest
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_if_BaseModel_instance_has_id(self):
        """ Check for id of baseModel instance """
        b = BaseModel()
        self.assertTrue(hasattr(b, "id"))

    def test_str_representation(self):
        """ Check if string representation is appropriate """
        b = BaseModel()
        self.assertEqual(str(b),
                         "[BaseModel] ({}) {}".format(b.id, b.__dict__))

    def test_id_id_unique(self):
        """ Check if id is randomly and uniquely generated """
        b1 = BaseModel()
        b2 = BaseModel()
